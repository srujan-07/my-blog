...
- Default Location: `C:/users/sruja/OneDrive/Documents/Obsidian Vault/blogs`

1. Open Obsidian.
2. Click **"Open folder as vault"**.
3. Point it to `C:/users/sruja/OneDrive/Documents/Obsidian Vault/blogs` (Create the folders if they don't exist).

### 2. Folder Structure
The sync script mirrors your Obsidian folder structure into the blog. You can organize your posts logically:
```text
C:/users/sruja/OneDrive/Documents/Obsidian Vault/blogs/
├── cves/
│   └── cve-2024-test.md
├── reversing/
│   └── malware-analysis.md
...
1. The script (`scripts/sync-posts.js`) scans `C:/users/sruja/OneDrive/Documents/Obsidian Vault/blogs`.
...
```json
{
  "sourcePath": "C:/users/sruja/OneDrive/Documents/Obsidian Vault/blogs",
  "targetPath": "posts",
  "git": {
    "autoCommit": true,
